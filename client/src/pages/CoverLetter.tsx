        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-16 p-8 rounded-xl border border-gray-200 bg-gray-50">
            ...
            <p className="text-gray-600">
              This feature is under development. Upload a job description and
              we'll generate a custom cover letter that highlights your relevant
